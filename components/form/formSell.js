  ...
  return (
    <>
      ...
      >
        ...
        <button
          class="pl-2/4 mt-10 flex h-12 cursor-pointer items-center justify-center rounded-md bg-white shadow-lg shadow-[#185ee041] hover:shadow-xl hover:shadow-[#185ee041] dark:from-indigo-800 dark:via-purple-600 dark:to-pink-400 dark:text-black lg:w-96"
          type="submit"
        >
